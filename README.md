...
- [Daily Digest — 2026-09-11](https://ew66.github.io/notes-gallery/digests/20260911_digest.html) — 4 方向 24 篇新論文 + 3 篇深度報告（Why Does PTQ Work? / Overpainting / Fiberwise OT）；arXiv API 驗證 (2026-09-11)
...
- [Why Does Post-Training Quantization Work?](https://ew66.github.io/notes-gallery/reports/20260911_WhyDoesPTQWork_LLM_Quant_Theory.html) — 隨機模型誤差迅速累積、預訓練模型誤差累積甚少；兩機制——逐層誤差相互抵消 + LM-head 各向異性幾何優先保留高排名 token 分數 (2026-09-11)
- [Overpainting: Localized Context-aware Diffusion Image Editing](https://ew66.github.io/notes-gallery/reports/20260911_Overpainting_Diffusion_Image_Editing.html) — trimap 三值遮罩（必改/可改/禁改）統一位置精度與上下文感知；joint attention + LoRA + attention-dropout 改造預訓練擴散編輯模型 (2026-09-11)
- [Model-Aware Schedules via Fiberwise Optimal Transport](https://ew66.github.io/notes-gallery/reports/20260911_Fiberwise_OT_Diffusion_Schedules.html) — 於訊號/噪聲分解的仿射纖維上定義預測風險，結合動能作用推出閉式最佳時間分配；CIFAR-10 flow matching 16 NFE 達 38.6% 相對 FID 降幅 (2026-09-11)
